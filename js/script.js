...
-------------------------------------------------------------*/
	...
	$(".arrow-down").click(function() {
		$("html, body").animate({scrollTop: $("body .container-box:nth-child(3)").position().top - 140}, 500);
		return false;
	});
...
--------------------------------------------------------------------*/
    ...
    function changeColor(hex) {
        ...
        var b = rgba & 0x0000ff;
        style.html('.navbar .btn-navbar .icon-bar, .btn-primary, .btn-primary:focus, .btn:hover{ background-color: ' + hex + ';} .navbar .nav > .active > a, .navbar .nav > .active > a:hover, .navbar .nav > .active > a:focus, .social.top i:hover, .navbar .nav > li > a:focus, .navbar .nav > li > a:hover{ border-color: ' + hex + ';} .page-title span, .team-item .hover-bottom .title, a, .soc-review-icon i, .footer-social li a:hover i, .team-item .social a:hover i, .soc-review-meta a, .navbar .brand{ color: ' + hex + ';} .team-item .statick .overlay, .btn-primary:hover{background: rgba('+ r +', '+ g +', '+ b +', .7);} .container-box.color, .works-item:hover, .works-item.open{background: rgba('+ r +', '+ g +', '+ b +', .1);} header .arrow-down:hover{background: rgba('+ r +', '+ g +', '+ b +', .8) url(img/arrow-down.png) no-repeat 50% ;} .btn-primary:active{background: rgba('+ r +', '+ g +', '+ b +', .5);} a:visited{color: rgba('+ r +', '+ g +', '+ b +', .5);} textarea:focus, input[type="text"]:focus, input[type="password"]:focus, input[type="datetime"]:focus, input[type="datetime-local"]:focus, input[type="date"]:focus, input[type="month"]:focus, input[type="time"]:focus, input[type="week"]:focus, input[type="number"]:focus, input[type="email"]:focus, input[type="url"]:focus, input[type="search"]:focus, input[type="tel"]:focus, input[type="color"]:focus, .uneditable-input:focus{box-shadow: 0 0 10px rgba('+ r +', '+ g +', '+ b +', .5);} .team-item .hover{box-shadow: 0 0 10px rgba('+ r +', '+ g +', '+ b +', .2);} textarea, input[type="text"], input[type="password"], input[type="datetime"], input[type="datetime-local"], input[type="date"], input[type="month"], input[type="time"], input[type="week"], input[type="number"], input[type="email"], input[type="url"], input[type="search"], input[type="tel"], input[type="color"], .uneditable-input{background: rgba('+ r +', '+ g +', '+ b +', .1);} input:-moz-placeholder, textarea:-moz-placeholder{color: red;} input:-ms-input-placeholder, textarea:-ms-input-placeholder{color: red;} input::-webkit-input-placeholder, textarea::-webkit-input-placeholder, #options-panel .button i{color: '+ hex +';}');
    }
